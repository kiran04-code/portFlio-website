...
const Navbar = () => {
  ...
  return (
    <nav className="  text-white font-poppins relative flex z-50 md:px-32">
    ...
    hover:text-orange-300 font-semibold transition-colors duration-200 ${show.name === "Contact" ? "bg-orange-400 px py-1  rounded-3xl p-2":null}   `  }
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-64  text-white transform ${isOpen ? "translate-x-0" : "-translate-x-full"
